...
public class Credits : SingletonWindowBase<Credits>
{
	...
	public void EnableNavContext()
	{
		...
		creditsScroller.GetNavigationContext().Activate();
	}
	...
	public void Update()
	{
		if ((NavigationController.instance?.activeContext?.IsInside(creditsScroller?.GetNavigationContext())).GetValueOrDefault() != wasInScroller)
		{
			UpdateMenuBars();
		}
	}
