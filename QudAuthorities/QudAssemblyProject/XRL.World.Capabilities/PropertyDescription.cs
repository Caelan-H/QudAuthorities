...
public static class PropertyDescription
{
	...
	[NonSerialized]
	public static List<string> BooleanProperties = new List<string> { "Analgesia", "BioScannerEquipped", "ForcefieldNullifier", "Serene", "StructureScannerEquipped", "TechScannerEquipped" };
