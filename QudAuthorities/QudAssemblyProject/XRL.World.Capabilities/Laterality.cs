...
public static class Laterality
{
	...
	public static StringBuilder BuildLateralityAdjective(int Laterality, out bool Conjoin, bool Capitalized = false)
	{
		...
		else if (((uint)Laterality & 0x10u) != 0)
		{
