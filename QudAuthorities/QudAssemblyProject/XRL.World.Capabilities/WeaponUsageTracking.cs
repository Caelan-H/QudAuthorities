...
public static class WeaponUsageTracking
{
	...
	{
		if (!GameObject.validate(ref Weapon) || Dmg == null || Dmg.Amount <= 0)
		{
			return;
		}
		if (DefenderIsCreature)
		{
			Weapon.ModIntProperty("InjuryAsThrownWeapon", Dmg.Amount);
			Weapon.SetIntProperty("LastInjuryAsThrownWeapon", Dmg.Amount);
			...
			if (Actor != null && Actor.IsPlayer())
			{
				Weapon.ModIntProperty("InjuryAsThrownWeaponByPlayer", Dmg.Amount);
				Weapon.SetIntProperty("LastInjuryAsThrownWeaponByPlayer", Dmg.Amount);
			...
			if (Accidental)
			{
				Weapon.ModIntProperty("AccidentalInjuryAsThrownWeapon", Dmg.Amount);
				Weapon.SetIntProperty("LastAccidentalInjuryAsThrownWeapon", Dmg.Amount);
				...
				if (Actor != null && Actor.IsPlayer())
				{
					Weapon.ModIntProperty("AccidentalInjuryAsThrownWeaponByPlayer", Dmg.Amount);
					Weapon.SetIntProperty("LastAccidentalInjuryAsThrownWeaponByPlayer", Dmg.Amount);
		...
		Weapon.ModIntProperty("DamageAsThrownWeapon", Dmg.Amount);
		Weapon.SetIntProperty("LastDamageAsThrownWeapon", Dmg.Amount);
		...
		if (Actor != null && Actor.IsPlayer())
		{
			Weapon.ModIntProperty("DamageAsThrownWeaponByPlayer", Dmg.Amount);
			Weapon.SetIntProperty("LastDamageAsThrownWeaponByPlayer", Dmg.Amount);
		...
		if (Accidental)
		{
			Weapon.ModIntProperty("AccidentalDamageAsThrownWeapon", Dmg.Amount);
			Weapon.SetIntProperty("LastAccidentalDamageAsThrownWeapon", Dmg.Amount);
			...
			if (Actor != null && Actor.IsPlayer())
			{
				Weapon.ModIntProperty("AccidentalDamageAsThrownWeaponByPlayer", Dmg.Amount);
				Weapon.SetIntProperty("LastAccidentalDamageAsThrownWeaponByPlayer", Dmg.Amount);
