...
public class Pistol_Akimbo : BaseSkill
{
	...
	{
		if (!base.WantEvent(ID, cascade) && ID != CanFireAllMissileWeaponsEvent.ID)
		{
	...
	{
		ActivatedAbilityID = AddMyActivatedAbility("Akimbo", "CommandToggleAkimbo", "Skill", null, "\u001d", null, Toggleable: true, DefaultToggleState: true);
	}
}
