...
public class FoundGuild : HistoricEvent
{
	public override void Generate()
	{
		...
		newEntity.ApplyEvent(new InitializeLocation(newRegion, int.Parse(snapshotAtYear.GetProperty("period"))));
		string text3;
		do
		{
		...
		newEntity.ApplyEvent(new SetEntityProperties(null, dictionary2));
