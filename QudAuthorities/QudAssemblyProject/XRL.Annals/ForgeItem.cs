...
public class ForgeItem : HistoricEvent
{
	public override void Generate()
	{
		...
		string text8 = Grammar.MakeTitleCase(QudHistoryHelpers.NameItemNounRoot(text2, history, entity));
		text5 = text5 + " <entity.subjectPronoun.capitalize> named it " + text8 + ".";
		text6 = text6 + " <entity.subjectPronoun.capitalize> named it " + text8 + ".";
		...
		text8 = QudHistoryHelpers.Ansify(text8);
		dictionary.Add("name", text8);
		...
		newEntity.ApplyEvent(new SetEntityProperties(dictionary, new Dictionary<string, string> { { "elements", randomElement } }));
		addEntityListItem("items", text8);
	}
}
