...
public class Marry : HistoricEvent
{
	public override void Generate()
	{
		...
		if (50.in100())
		{
			...
			text4 = ((factionMembers.Count <= 0) ? NameMaker.MakeName(null, null, null, null, "Qudish", null, null, null, null, "Site") : NameMaker.MakeName(GameObject.create(factionMembers.GetRandomElement().Name)));
			...
			if (90.in100())
			{
				...
				newEntity.ApplyEvent(new SetEntityProperties(dictionary, new Dictionary<string, string>
				{
					{ "lovedFactions", text2 },
					{ "elements", "none" }
				}));
		...
		else
		{
			...
			text4 = NameMaker.MakeName(null, null, null, null, "Qudish", null, null, null, null, "Site");
