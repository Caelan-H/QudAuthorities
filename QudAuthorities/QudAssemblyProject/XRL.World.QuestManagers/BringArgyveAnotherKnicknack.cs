...
[Serializable]
public class BringArgyveAnotherKnicknack : QuestManager
{
	public override void OnQuestAdded()
	{
		XRLCore.Core.Game.Player.Body.Inventory.ForeachObject(delegate(GameObject GO)
		{
			...
			{
				XRLCore.Core.Game.FinishQuestStep("Fetch Argyve Another Knickknack", "Find Another Knickknack");
				return false;
			}
			return true;
		});
	...
	public override bool FireEvent(Event E)
	{
		if (E.ID == "Took")
		{
			...
			{
				The.Game.FinishQuestStep("Fetch Argyve Another Knickknack", "Find Another Knickknack");
			}
		}
