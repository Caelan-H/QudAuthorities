...
public class CookingDomainFear_UnitIntimidate : ProceduralCookingEffectUnitSkill<Persuasion_Intimidate>
{
	public override string GetDescription()
	{
		...
		return "+" + Tier * 2 + " bonus on Ego roll when using Intimidate.";
	}
	...
	public override string GetTemplatedDescription()
	{
		...
		if (BonusTier != "0")
		{
			text = text + " If @they already have " + base.SkillDisplayName + ", gain a +" + Tier * 2 + " bonus on the Ego roll when using " + base.SkillDisplayName + ".";
		}
		return text;
	}
}
