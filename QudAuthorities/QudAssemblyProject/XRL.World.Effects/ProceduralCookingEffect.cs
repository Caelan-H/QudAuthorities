...
public class ProceduralCookingEffect : Effect
{
	...
	{
		base.DisplayName = "{{W|metabolizing}}";
		base.Duration = 1;
	}
	...
	{
		if (!base.WantEvent(ID, cascade) && ID != AIBoredEvent.ID && ID != AfterGameLoadedEvent.ID)
		{
	...
	public override void Register(GameObject Object)
	{
		...
		Object.RegisterEffectEvent(this, "JoinedPartyLeader");
		Object.RegisterEffectEvent(this, "RemoveProceduralCookingEffects");
	...
	public override void Unregister(GameObject Object)
	{
		...
		Object.UnregisterEffectEvent(this, "JoinedPartyLeader");
		Object.UnregisterEffectEvent(this, "RemoveProceduralCookingEffects");
	...
	{
		if (base.Duration > 0 && base.Object != null && !base.Object.IsPlayer() && !base.Object.WasPlayer() && Calendar.TotalTimeTicks >= StartTick + GetNonPlayerDuration())
		{
	...
	{
		return (base.Object?.GetPart("Stomach") as Stomach)?.CalculateCookingIncrement() ?? 1200;
	}
