...
public class CookingDomainPhase_UnitPhaseOnDamage : ProceduralCookingEffectUnit
{
	...
	public override void FireEvent(Event E)
	{
		...
		if (@object != null && Stat.Random(1, 100) <= Tier && @object.CurrentCell != null && !@object.OnWorldMap() && !@object.HasEffect("Phased") && @object.LocalEvent("CheckRealityDistortionAccessibility"))
		{
