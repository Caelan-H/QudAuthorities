...
public class Flagging : Effect
{
	...
	public override bool HandleEvent(BeginTakeActionEvent E)
	{
		if (base.Duration > 0)
		{
			...
			{
				IComponent<GameObject>.AddPlayerMessage("You're going to collapse from exhaustion in " + Grammar.Cardinal(base.Duration) + " " + ((base.Duration == 1) ? "round" : "rounds") + ".");
			}
		}
