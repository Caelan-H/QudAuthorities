...
[Serializable]
public class Rubbergum_Tonic : ITonicEffect
{
	...
	public override void Register(GameObject Object)
	{
		...
		Object.RegisterEffectEvent(this, "BeforeGrabbed");
	...
	public override void Unregister(GameObject Object)
	{
		...
		Object.UnregisterEffectEvent(this, "BeforeGrabbed");
	...
	public override void ApplyAllergy(GameObject Object)
	{
		...
		Object.ApplyEffect(new Rubbergum_Tonic_Allergy(base.Duration));
	}

	public override bool Render(RenderEvent E)
	{
		int num = XRLCore.CurrentFrame % 60;
		if (base.Duration > 0 && num > 50 && num < 60)
		{
			E.Tile = null;
			E.RenderString = "O";
			E.ColorString = "&r";
