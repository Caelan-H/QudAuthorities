...
public static class Easing
{
	...
	{
		return Mathf.Sin(20.4203529f * p) * Mathf.Pow(2f, 10f * (p - 1f));
	}

	public static float ElasticEaseOut(float p)
	{
		return Mathf.Sin(-20.4203529f * (p + 1f)) * Mathf.Pow(2f, -10f * p) + 1f;
	}
	...
	public static float ElasticEaseInOut(float p)
	{
		if (p < 0.5f)
		{
			return 0.5f * Mathf.Sin(20.4203529f * (2f * p)) * Mathf.Pow(2f, 10f * (2f * p - 1f));
		}
		return 0.5f * (Mathf.Sin(-20.4203529f * (2f * p - 1f + 1f)) * Mathf.Pow(2f, -10f * (2f * p - 1f)) + 2f);
	}
