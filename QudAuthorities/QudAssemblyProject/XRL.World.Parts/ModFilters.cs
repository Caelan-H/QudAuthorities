...
public class ModFilters : IModification
{
	...
	{
		if (!base.WantEvent(ID, cascade) && ID != BeforeApplyDamageEvent.ID && ID != GetDisplayNameEvent.ID && ID != GetRespiratoryAgentPerformanceEvent.ID && ID != GetShortDescriptionEvent.ID)
		{
	...
	public override bool HandleEvent(BeforeApplyDamageEvent E)
	{
		...
		{
			E.Damage.Amount = E.Damage.Amount * (100 - GetFilterPerformance()) / 100;
		}
		return base.HandleEvent(E);
	}
