...
public class PlayerDanceRitual : IPart
{
	...
	private GameObject Opponent
	{
		get
		{
			if (_Opponent == null)
			{
				_Opponent = ParentObject.pPhysics.CurrentCell.ParentZone.FindObject("Angor");
			}
			return _Opponent;
		}
	}
	...
	public override void Register(GameObject Object)
	{
		...
		Object.RegisterPartEvent(this, "CanHaveConversation");
		Object.RegisterPartEvent(this, "EndAction");
		Object.RegisterPartEvent(this, "EndTurn");
		Object.RegisterPartEvent(this, "DanceOpponentDied");
		if (Opponent == null)
		{
	...
	public override bool FireEvent(Event E)
	{
		...
		if (E.ID == "EndTurn")
		{
			...
			n++;
			if (ParentObject.pPhysics.CurrentCell.ParentZone.FindObject("Angor") == null)
			{
