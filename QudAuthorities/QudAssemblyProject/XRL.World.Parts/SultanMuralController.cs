...
public class SultanMuralController : IPart
{
	...
	public static void ruinMural(List<Cell> muralCells, HistoricEvent ev)
	{
		...
		for (int i = 0; i < 3; i++)
		{
			...
			firstObjectWithPart.pRender.RenderString = ((char)num2).ToString();
			firstObjectWithPart.pRender.Tile = "Walls/sw_mural_ruined" + num + "_" + text2 + ".bmp";
			firstObjectWithPart.pPhysics.Category = eventProperty;
	...
	public void updateHistoricMural(List<Cell> muralCells, HistoricEvent ev)
	{
		...
		for (int i = 0; i < 3; i++)
		{
			...
			{
				firstObjectWithPart.pRender.RenderString = ((char)muralAscii[text][i]).ToString();
			}
			firstObjectWithPart.pRender.Tile = "Walls/sw_mural_" + text + "_" + text3 + ".bmp";
			...
			{
				firstObjectWithPart.GetPart<SultanMural>().secretID = journalSultanNote.secretid;
