...
public class CyberneticsAutomatedInternalDefibrillator : IPoweredPart
{
	...
	public override void TurnTick(long TurnNumber)
	{
		...
		if (implantee != null && implantee.HasEffect("CardiacArrest") && IsReady(UseCharge: true, IgnoreCharge: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L) && GetChance(implantee).in100())
		{
