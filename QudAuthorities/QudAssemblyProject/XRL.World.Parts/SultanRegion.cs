...
public class SultanRegion : IPart
{
	...
	{
		Object.RegisterPartEvent(this, "SultanReveal");
	...
	public override bool FireEvent(Event E)
	{
		if (E.ID == "SultanReveal")
		{
			...
			default:
				if (property == "religion" || property == "profession")
				{
					...
					case 14:
						...
						break;
					case 15:
						ParentObject.pRender.Tile = "HistoricRing";
						break;
					}
				}
				else
			...
			{
				ParentObject.pRender.Tile = gameObjectBlueprint.GetPart("Render").Parameters["Tile"];
				ParentObject.pRender.ColorString = "&" + Crayons.GetRandomColorAll();
			}
			else
			{
				ParentObject.pRender.Tile = "Terrain/sw_historic_pantheon.bmp";
				ParentObject.pRender.ColorString = "&" + Crayons.GetRandomColorAll();
			}
			do
			{
			...
			ParentObject.pRender.DisplayName = text7;
