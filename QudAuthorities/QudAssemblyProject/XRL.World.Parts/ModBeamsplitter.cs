...
public class ModBeamsplitter : IModification
{
	...
	public override void ApplyModification(GameObject Object)
	{
		...
		{
			missileWeapon.ShotsPerAction *= 3;
			missileWeapon.ShotsPerAnimation *= 3;
		}
	...
	{
		if (!base.WantEvent(ID, cascade) && ID != GetDisplayNameEvent.ID && ID != GetFixedMissileSpreadEvent.ID && ID != GetMissileWeaponPerformanceEvent.ID)
		{
	...
	{
		return "Fitted with beamsplitter: This weapon has " + Grammar.A(3) + "-way spread with each shot at -1 penetration.";
	}
}
