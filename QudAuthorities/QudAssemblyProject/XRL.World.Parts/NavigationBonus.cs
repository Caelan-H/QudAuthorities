...
public class NavigationBonus : IPoweredPart
{
	...
	{
		if (!base.WantEvent(ID, cascade) && ID != EncounterChanceEvent.ID && ID != GetDebugInternalsEvent.ID && ID != GetLostChanceEvent.ID && (ID != GetShortDescriptionEvent.ID || !ShowInShortDescription))
		{
