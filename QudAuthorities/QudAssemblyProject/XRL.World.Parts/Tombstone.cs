...
public class Tombstone : IPart
{
	...
	public void GenerateTombstone()
	{
		...
		{
			GameObject gameObject = GameObject.createSample(EncountersAPI.GetARandomDescendentOf("Item"));
		...
		{
			GameObject gameObject2 = GameObject.createSample(EncountersAPI.GetARandomDescendentOf("Item"));
			text = new string[2] { "Crushed to death by a falling ", "Fell from a cliff trying to recover a lost " }.GetRandomElement();
			text += gameObject2.GetDisplayName(int.MaxValue, null, null, 75.in100(), Single: false, NoConfusion: false, NoColor: false, Stripped: true, ColorOnly: false, Visible: true, WithoutEpithet: false, Short: true);
		...
		{
			GameObject gameObject3 = GameObject.createSample(EncountersAPI.GetARandomDescendentOf("Food"));
			text = new string[3] { "Choked on ", "Ate too much ", "Died of malnutrition after eating only " }.GetRandomElement();
			text = ((!text.StartsWith("Choked")) ? (text + gameObject3.GetDisplayName(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true, ColorOnly: false, Visible: true, WithoutEpithet: false, Short: true)) : (text + gameObject3.an(int.MaxValue, null, null, AsIfKnown: false, Single: false, NoConfusion: false, NoColor: false, Stripped: true)));
			gameObject3.Obliterate();
		}
		else if (num < 475)
		{
			GameObject gameObject4 = GameObject.createSample(EncountersAPI.GetARandomDescendentOf("Tonic"));
		...
		else if (num < 500)
		{
			...
			GameObject gameObject5 = GameObject.createSample(EncountersAPI.GetARandomDescendentOf("Tonic"));
			text = string.Concat(str1: gameObject5.GetDisplayName(int.MaxValue, null, null, 75.in100(), Single: false, NoConfusion: false, NoColor: false, Stripped: true, ColorOnly: false, Visible: true, WithoutEpithet: false, Short: true), str0: list.GetRandomElement(), str2: " too many");
			gameObject5.Obliterate();
		}
		else if (num < 525)
		{
			GameObject gameObject6 = GameObject.createSample(EncountersAPI.GetARandomDescendentOf("Gas"));
			text = new string[4] { "Choked to death on ", "Suffocated in ", "Breathed too much ", "Released a canister of " }.GetRandomElement();
			text = ((!text.StartsWith("Choked")) ? (text + gameObject6.GetDisplayName(int.MaxValue, null, null, 75.in100(), Single: false, NoConfusion: false, NoColor: false, Stripped: true, ColorOnly: false, Visible: true, WithoutEpithet: false, Short: true)) : (text + gameObject6.an(int.MaxValue, null, null, 75.in100(), Single: false, NoConfusion: false, NoColor: false, Stripped: true)));
		...
		{
			GameObject gameObject7 = GameObject.createSample(EncountersAPI.GetARandomDescendentOf("Grenade"));
		...
		{
			GameObject gameObject8 = GameObject.createSample(EncountersAPI.GetARandomDescendentOf("Book"));
			string[] list2 = new string[2] { "Knocked over the head with a copy of ", "Burned at the stake for promulgating " };
			text = string.Concat(str1: gameObject8.GetDisplayName(int.MaxValue, null, null, AsIfKnown: true, Single: false, NoConfusion: false, NoColor: false, Stripped: true, ColorOnly: false, Visible: true, WithoutEpithet: false, Short: true), str0: list2.GetRandomElement());
			gameObject8.Obliterate();
		}
		else if (num < 625)
		{
			GameObject gameObject9 = GameObject.createSample(EncountersAPI.GetARandomDescendentOf("Book"));
			string displayName3 = gameObject9.GetDisplayName(int.MaxValue, null, null, AsIfKnown: true, Single: false, NoConfusion: false, NoColor: false, Stripped: true, ColorOnly: false, Visible: true, WithoutEpithet: false, Short: true);
		...
		else if (num < 675)
		{
			...
			GameObject gameObject10 = GameObject.createSample(EncountersAPI.GetARandomDescendentOf("LightSource"));
		...
		else if (num < 700)
		{
			...
			GameObject gameObject11 = GameObject.createSample(EncountersAPI.GetARandomDescendentOf("WaterContainer"));
			text = list4.GetRandomElement() + gameObject11.GetDisplayName(int.MaxValue, null, null, 75.in100(), Single: false, NoConfusion: false, NoColor: false, Stripped: true, ColorOnly: false, Visible: true, WithoutEpithet: false, Short: true);
			gameObject11.Obliterate();
		}
		else if (num < 750)
		{
			string[] list5 = new string[1] { "Made too many mocking sounds at " };
			GameObject gameObject12 = GameObject.createSample(EncountersAPI.GetARandomDescendentOf("BaseApe"));
