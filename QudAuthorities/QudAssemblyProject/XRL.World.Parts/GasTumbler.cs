...
public class GasTumbler : IPoweredPart
{
	...
	public override bool FireEvent(Event E)
	{
		...
		else if (E.ID == "CreatorModifyGas")
		{
			...
			if (IsReady(UseCharge: false, IgnoreCharge: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, num3) && E.GetParameter("Gas") is Gas gas)
			{
