...
public class BroadcastPowerTransmitter : IPoweredPart
{
	...
	public override bool WantEvent(int ID, int cascade)
	{
		...
		{
			return ID == CollectBroadcastChargeEvent.ID;
		}
		return true;
	}
	...
	public override int GetDraw(QueryDrawEvent E = null)
	{
		...
		if (anyBasisZone != null && anyBasisZone.IsActive() && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L))
		{
			bool flag = false;
			int num2 = 0;
			int num3 = 0;
