...
public class ModSmart : IModification
{
	...
	{
		return "Smart: When powered and started up and the wielder has a HUD or techscanner equipped, this weapon's tracking scope makes it more accurate and gives " + ((Tier > 0) ? ("+" + GetModificationLevel(Tier)) : "a bonus") + " to hit a target aimed at.";
	}
