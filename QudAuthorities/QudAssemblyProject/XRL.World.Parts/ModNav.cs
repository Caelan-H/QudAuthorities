...
public class ModNav : IModification
{
	...
	public override void ApplyModification(GameObject Object)
	{
		...
		else
		{
			...
			{
				NavigationBonus navigationBonus2 = navigationBonus;
				navigationBonus2.PercentBonus = navigationBonus2.PercentBonus + "+" + num;
			}
			...
			{
				NavigationBonus navigationBonus3 = navigationBonus;
				navigationBonus3.EncounterPercentBonus = navigationBonus3.EncounterPercentBonus + "+" + num2;
			}
			...
			{
				NavigationBonus navigationBonus4 = navigationBonus;
				navigationBonus4.SpeedPercentBonus = navigationBonus4.SpeedPercentBonus + "+" + num3;
			}
