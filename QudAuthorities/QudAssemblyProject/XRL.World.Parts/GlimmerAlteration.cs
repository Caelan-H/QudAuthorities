...
public class GlimmerAlteration : IPoweredPart
{
	...
	{
		if (!base.WantEvent(ID, cascade) && ID != BootSequenceDoneEvent.ID && ID != EquippedEvent.ID && (ID != GetPsychicGlimmerEvent.ID || Amount == 0) && (ID != GetShortDescriptionEvent.ID || !ShowInShortDescription))
		{
	...
	{
		if (Amount != 0 && IsObjectActivePartSubject(E.Subject) && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L))
		{
