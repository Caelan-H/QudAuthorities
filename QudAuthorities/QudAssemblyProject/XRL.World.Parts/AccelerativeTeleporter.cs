...
public class AccelerativeTeleporter : IPoweredPart
{
	...
	{
		if (!base.WantEvent(ID, cascade) && ID != EffectAppliedEvent.ID && ID != EffectRemovedEvent.ID && ID != EquippedEvent.ID && ID != GetItemElementsEvent.ID)
		{
	...
	{
		if (CurrentDirection != null && !IsReady(UseCharge: false, IgnoreCharge: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L))
		{
			ResetAcceleration();
		}
	...
	public override bool HandleEvent(EquippedEvent E)
	{
		...
		E.Actor.RegisterPartEvent(this, "AfterTravel");
	...
	public override bool HandleEvent(UnequippedEvent E)
	{
		...
		E.Actor.UnregisterPartEvent(this, "AfterTravel");
	...
	public bool PerformAccelerativeTeleport(GameObject who, string dir, Event E, int? PowerLoad = null)
	{
		...
		{
			who.CellTeleport(cell, E, ParentObject, who, null, null, 0, Forced: false, DoTeleportVisualEffects, DoTeleportReducedVisualEffects);
		}
		return true;
	}
	...
	private bool ProcessMoveInner(Cell oldCell, Cell newCell, Event E, bool forced)
	{
		...
		if (!IsReady(UseCharge: false, IgnoreCharge: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: true, 0L))
		{
			return false;
		}
	...
	public override bool FireEvent(Event E)
	{
		...
		else if (E.ID == "AfterTravel")
		{
			if (AcceleratedTravel && ChargeUse > 0 && IsReady(UseCharge: false, IgnoreCharge: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L))
			{
				int num4 = E.GetIntParameter("Segments") / 10;
				ParentObject.UseCharge(ChargeUse * num4, LiveOnly: false, 0L);
		...
		else if (E.ID == "CellChanged" && CurrentDirection != null && !IsReady(UseCharge: false, IgnoreCharge: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L))
		{
			ResetAcceleration();
		}
