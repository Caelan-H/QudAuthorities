...
public class ReduceEnergyCosts : IPoweredPart
{
	...
	{
		if (GenerateShortDescription && (WorksOnEquipper || WorksOnWearer || WorksOnHolder || WorksOnCarrier || WorksOnImplantee) && (!string.IsNullOrEmpty(PercentageReduction) || !string.IsNullOrEmpty(LinearReduction)))
		{
