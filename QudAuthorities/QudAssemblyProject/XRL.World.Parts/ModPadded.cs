...
public class ModPadded : IModification
{
	...
	{
		if (!base.WantEvent(ID, cascade) && ID != EquippedEvent.ID && ID != GetDisplayNameEvent.ID && ID != GetMaximumLiquidExposureEvent.ID && ID != GetShortDescriptionEvent.ID)
		{
	...
	{
		Object.RegisterPartEvent(this, "GetShakeItOffChance");
