...
public class Flywheel : IPoweredPart
{
	...
	{
		if (!base.WantEvent(ID, cascade) && ID != ChargeAvailableEvent.ID && ID != EffectAppliedEvent.ID && ID != GetDisplayNameEvent.ID && ID != ModifyDefendingSaveEvent.ID && ID != ObjectCreatedEvent.ID && ID != QueryChargeEvent.ID && ID != QueryChargeStorageEvent.ID && ID != TestChargeEvent.ID)
		{
