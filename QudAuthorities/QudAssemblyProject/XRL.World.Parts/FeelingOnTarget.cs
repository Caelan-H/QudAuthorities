...
public class FeelingOnTarget : IActivePart
{
	...
	public override bool FireEvent(Event E)
	{
		if (E.ID == "AITargetCreateKill")
		{
			...
			if (activePartFirstSubject == null || IsDisabled(UseCharge: true, IgnoreCharge: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L))
			{
				return true;
			}
			if (!CalmHate)
			...
			if (Chance.in100())
			{
				...
				gameObjectParameter.SetFeeling(activePartFirstSubject, Feeling);
