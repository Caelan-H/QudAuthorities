...
public class PartsGas : IPoweredPart
{
	...
	public override void TurnTick(long TurnNumber)
	{
		...
		if (IsReady(UsesChargePerTurn, IgnoreCharge: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, num))
		{
	...
	public void PerformGasRepulsion(Cell FromCell = null, int PowerLoad = int.MinValue)
	{
		...
		for (int count = localAdjacentCells.Count; i < count; i++)
		{
			...
			{
				if (!UsesChargePerEachEffect || IsReady(UseCharge: true, IgnoreCharge: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L, PowerLoad))
				{
