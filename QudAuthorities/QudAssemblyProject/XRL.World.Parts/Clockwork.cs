...
public class Clockwork : IPoweredPart
{
	...
	{
		if (!base.WantEvent(ID, cascade) && ID != ChargeAvailableEvent.ID && ID != EffectAppliedEvent.ID && ID != GetDisplayNameEvent.ID && (ID != ObjectCreatedEvent.ID || string.IsNullOrEmpty(StartCharge)) && ID != QueryChargeEvent.ID && ID != QueryChargeStorageEvent.ID && ID != TestChargeEvent.ID)
		{
	...
	{
		if ((CatastrophicDisable || ChargeLossDisable) && IsDisabled(UseCharge: false, IgnoreCharge: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L))
		{
	...
	{
		if (IsReady(UseCharge: false, IgnoreCharge: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L) && E.Amount > 0 && Charge < MaxCharge)
		{
			int num = E.Amount;
	...
	{
		if (E.ID == "BeforeDeathRemoval" && MinimumChargeToExplode > 0 && Charge >= MinimumChargeToExplode && (CatastrophicDisable || !IsDisabled(UseCharge: false, IgnoreCharge: false, IgnoreBootSequence: false, IgnoreBreakage: false, IgnoreRust: false, IgnoreEMP: false, IgnoreRealityStabilization: false, IgnoreSubject: false, IgnoreLocallyDefinedFailure: false, 1, null, UseChargeIfUnpowered: false, 0L)))
		{
			if (Visible())
			{
