...
public class GiantClamProperties : IPart
{
	...
	public bool CheckTeleport(GameObject Object, Cell C = null)
	{
		...
		if (C.ParentZone.Built)
		{
			if (Object.IsPlayer() && !ParentObject.HasIntProperty("EnteredByPlayer"))
			{
				...
				AchievementManager.IncrementAchievement("ACH_100_CLAMS_ENTERED");
				if (ParentObject.HasIntProperty("MakClam"))
				{
					AchievementManager.SetAchievement("ACH_ENTER_MAK_CLAM");
				}
			}
	...
	{
		if (Object != null && Object != ParentObject && Object.IsReal && Object.pBrain != null && Object.GetLongProperty("ClamTeleportTurn") != The.Game.Turns && ParentObject.PhaseAndFlightMatches(Object))
		{
	...
	public static bool Teleport(GameObject Object, Cell TargetCell, char Color)
	{
		...
		bool result = Object.TeleportTo(TargetCell, 0, ignoreCombat: true, ignoreGravity: false, forced: false, "disappear", null);
		if (Object.IsPlayer())
		{
		...
		Object.pPhysics.PlayWorldSound("Splash_Step1");
	...
	public void TeleportToClamWorld(GameObject Object)
	{
		...
		SoundManager.PlayMusic("Clam Dimension", Crossfade: true, 20f);
		...
		if (!The.Game.HasBooleanGameState("VisitedTzimtzlum"))
		{
			...
			JournalAPI.AddAccomplishment("While dimensionally lost, you discovered a passageway to the pocket dimension Tzimtzlum and traveled there.", "Via the power of an imaginative mind at cosmological scales, =name= created the pocket dimension Tzimtzlum and traveled there, immanentizing it for all astral wanderers.", "general", JournalAccomplishment.MuralCategory.VisitsLocation, JournalAccomplishment.MuralWeight.High, null, -1L);
			AchievementManager.SetAchievement("ACH_TRAVEL_TZIMTZLUM");
