...
{
	public static bool MakeRegionCaveBuilding(Zone Z, InfluenceMap IF, InfluenceMapRegion R, string DoorObject = "Door", string WallObject = "WoodWall", int WallRadius = 4, string BuildingDecorationPopulation = null, string BuildingCreaturePopulation = null, Location2D Anchor = null)
	{
		bool flag = false;
