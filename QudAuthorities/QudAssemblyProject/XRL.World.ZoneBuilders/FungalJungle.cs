			...
			foreach (Location2D cell in region.Cells)
			{
				...
				if ((20f * num).in100())
				{
					if (!Z.GetCell(x, y).IsOccluding())
					{
						...
						gameObject2.pRender.SetForegroundColor(randomElement);
						gameObject2.pRender.DetailColor = randomElement2;
				...
				else if ((20f * num).in100())
				{
					if (!Z.GetCell(x, y).IsOccluding())
					{
						...
						string randomElement = list.GetRandomElement();
						string randomElement2 = new List<string>(list).GetRandomElement();
						gameObject3.pRender.SetForegroundColor(randomElement);
						gameObject3.pRender.DetailColor = randomElement2;
				...
				else if ((30f * num).in100() && !Z.GetCell(x, y).IsOccluding())
				{
					...
					string randomElement = list.GetRandomElement();
					string randomElement2 = new List<string>(list).GetRandomElement();
					gameObject4.pRender.SetForegroundColor(randomElement);
					gameObject4.pRender.DetailColor = randomElement2;
