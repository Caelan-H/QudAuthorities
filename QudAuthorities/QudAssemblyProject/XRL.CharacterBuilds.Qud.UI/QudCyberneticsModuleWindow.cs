...
[UIView("CharacterCreation:PickCybernetics", false, false, false, null, null, false, 0, false, NavCategory = "Menu", UICanvas = "Chargen/PickCybernetics", UICanvasHost = 1)]
public class QudCyberneticsModuleWindow : EmbarkBuilderModuleWindowPrefabBase<QudCyberneticsModule, CategoryMenusScroller>
{
	...
	public override void RandomSelection()
	{
		...
		base.prefabComponent.ContextFor(0, num).Activate();
		pickCybernetic(num);
		UpdateControls();
	}
