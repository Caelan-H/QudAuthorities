...
[UIView("CharacterCreation:SubtypeCategory", false, false, false, null, null, false, 0, false, NavCategory = "Menu", UICanvas = "Chargen/PickSubtypeCategory", UICanvasHost = 1)]
public class QudSubtypeModuleCategoryWindow : QudSubtypeModuleWindow
{
	...
	public override void RandomSelection()
	{
		...
		var anon = list[index];
		base.prefabComponent.GetPrefabForIndex(anon.catn).GetComponent<FrameworkScroller>().scrollContext.GetContextAt(anon.choicen).Activate();
