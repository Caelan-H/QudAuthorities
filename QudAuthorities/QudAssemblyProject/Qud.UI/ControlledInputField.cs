...
public class ControlledInputField : InputField, IControlledSelectable
{
	...
	public bool selected
	{
		get
		{
			return wasSelected.GetValueOrDefault();
		}
		set
		{
	...
	public void Init()
	{
		base.onEndEdit.AddListener(UpdateValue);
		base.onValueChanged.AddListener(UpdateValue);
	}
