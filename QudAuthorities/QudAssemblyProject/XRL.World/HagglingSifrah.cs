...
public class HagglingSifrah : SocialSifrah
{
	...
	{
		Description = "Haggling with " + ContextObject.an(int.MaxValue, null, null, AsIfKnown: false, Single: true, NoConfusion: false, NoColor: false, Stripped: false, WithoutEpithet: false, Short: false);
		...
		{
			Popup.ShowFail("You have no usable options to employ for haggling with " + ContextObject.t() + ", giving you no chance of success. You can remedy this situation by improving your Ego and social skills, or by obtaining items useful in social situations.");
			Finished = true;
			Abort = true;
		}
	}
