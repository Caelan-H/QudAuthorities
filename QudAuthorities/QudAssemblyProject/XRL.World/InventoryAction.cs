...
public class InventoryAction
{
	...
	public IEvent Process(GameObject GO, GameObject Owner, bool Telekinetic = false)
	{
		...
		if (AsMinEvent)
		{
			InventoryActionEvent.Check(out GeneratedEvent, gameObject, Owner, GO, Command, Auto: false, OwnershipHandled: false, OverrideEnergyCost: false, 0, 0, (GameObject)null, (Cell)null, (Cell)null);
		}
		else
		{
