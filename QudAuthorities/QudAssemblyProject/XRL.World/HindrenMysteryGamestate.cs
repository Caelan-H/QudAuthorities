...
[Serializable]
[GamestateSingleton("hindrenClueGamestate")]
public class HindrenMysteryGamestate : IGamestateSingleton
{
	...
	public static HindrenMysteryGamestate instance
	{
		get
		{
			...
			return XRLCore.Core.Game.GetObjectGameState("hindrenClueGamestate") as HindrenMysteryGamestate;
		}
	}
	...
	public void foundClue()
	{
		...
		{
			XRLCore.Core.Game.FinishQuestStep("Kith and Kin", "Optional: Discover all the evidence");
		}
	}
