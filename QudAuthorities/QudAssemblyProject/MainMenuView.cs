...
[UIView("MainMenu", true, true, false, "Menu", "MainMenu", false, 0, false)]
public class MainMenuView : BaseView
{
	...
	public override void Enter()
	{
		...
		base.Enter();
		Select(FindChild("New Game"));
		FindChild("Version").GetComponent<UnityEngine.UI.Text>().text = Assembly.GetExecutingAssembly().GetName().Version.ToString();
		DisplayAlert();
	}
