...
public class UAP_AccessibilityManager : MonoBehaviour
{
				...
				if (componentInParent != null)
				{
					...
					if (!flag2)
					{
						...
						if (componentInParent.horizontal && flag3)
						{
							...
							if (!(num3 >= num4))
							{
								float num6 = (componentInParent.horizontalNormalizedPosition = num3 / num4);
							}
							else
							{
						...
						if (componentInParent.vertical && flag4)
						{
							...
							float num7 = array[2].y - array[0].y;
							float num8 = array3[2].y - array3[0].y;
							float num9 = array2[0].y - array3[0].y;
							float num10 = num8 - num7;
							if (!(num9 >= num10))
							{
								float num12 = (componentInParent.verticalNormalizedPosition = num9 / num10);
							}
							else
							{
	...
	private int GetTouchCount()
	{
		...
		if (Input.GetMouseButton(1) && (Input.GetKey(KeyCode.LeftAlt) || Input.GetKey(KeyCode.LeftCommand)))
		{
			return 3;
		}
