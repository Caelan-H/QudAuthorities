...
public class GlobalState
{
	...
	public static GlobalState instance
	{
		get
		{
			if (_instance == null)
			{
				string path = DataManager.SavePath("GlobalState.json");
				if (!File.Exists(path))
				{
	...
	public void save()
	{
		File.WriteAllText(DataManager.SavePath("GlobalState.json"), JsonConvert.SerializeObject(this, Formatting.Indented, new JsonSerializerSettings
		{
