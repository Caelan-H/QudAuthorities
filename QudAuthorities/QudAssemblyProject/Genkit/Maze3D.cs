...
public class Maze3D
{
	...
	public static Maze3D Load(SerializationReader Reader)
	{
		...
		for (short num = 0; num < maze3D.Width; num = (short)(num + 1))
		{
			for (short num2 = 0; num2 < maze3D.Height; num2 = (short)(num2 + 1))
			{
				for (short num3 = 0; num3 < maze3D.Depth; num3 = (short)(num3 + 1))
				{
	...
	public void Init(int _Width, int _Height, int _Depth, bool Value)
	{
		...
		for (short num = 0; num < Width; num = (short)(num + 1))
		{
			for (short num2 = 0; num2 < Height; num2 = (short)(num2 + 1))
			{
				for (short num3 = 0; num3 < Depth; num3 = (short)(num3 + 1))
				{
