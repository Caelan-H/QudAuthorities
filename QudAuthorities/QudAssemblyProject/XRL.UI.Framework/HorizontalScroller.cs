...
public class HorizontalScroller : FrameworkScroller
{
	...
	public override void BeforeShow(EmbarkBuilderModuleWindowDescriptor descriptor, IEnumerable<FrameworkDataElement> selections = null)
	{
		...
		if (scrollContext.selectedPosition != num)
		{
	...
	{
		MetricsManager.LogEditorInfo("CalculateGridColumns for " + base.gameObject.name);
		if (base.gridLayout == null)
		{
			MetricsManager.LogEditorInfo("null");
			return 0;
		}
		...
		MetricsManager.LogEditorInfo(num.ToString());
		return num;
	}
