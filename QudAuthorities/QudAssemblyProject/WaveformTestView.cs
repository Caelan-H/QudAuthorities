...
[UIView("WaveformTest", false, false, false, null, "WaveformTest", false, 0, false)]
public class WaveformTestView : BaseView
{
	public int seed;
	...
	public override void OnCommand(string Command)
	{
		...
		if (Command == "Generate Fast")
		{
			...
			texture2D.Apply();
			Sprite sprite2 = (component.sprite = UnityEngine.Sprite.Create(texture2D, new Rect(0f, 0f, texture2D.width, texture2D.height), new Vector2(0f, 0f)));
		}
		if (!(Command == "Generate"))
		{
			return;
		...
		texture2D2.Apply();
		Sprite sprite4 = (component2.sprite = UnityEngine.Sprite.Create(texture2D2, new Rect(0f, 0f, texture2D2.width, texture2D2.height), new Vector2(0f, 0f)));
	}
}
